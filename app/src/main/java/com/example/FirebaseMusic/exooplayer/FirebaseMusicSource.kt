...
class FirebaseMusicSource @Inject constructor(
   ...
   private var state: State = State.STATE_CREATED//초기값
       set(value) {
    ...
    fun fetchMediaData(disposable: CompositeDisposable){
        state=State.STATE_INITIALIZING//호출되면 initialilzing
        musicDatabase.getAllSongs(disposable){fetchedSongs->
